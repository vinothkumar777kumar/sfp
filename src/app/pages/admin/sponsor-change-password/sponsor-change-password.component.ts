...
@Component({
  selector: 'app-sponsor-change-password',
  templateUrl: './sponsor-change-password.component.html',
  styleUrls: ['./sponsor-change-password.component.css']
})
export class SponsorChangePasswordComponent implements OnInit {

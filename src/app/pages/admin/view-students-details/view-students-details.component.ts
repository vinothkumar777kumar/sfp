...
@Component({
  selector: 'app-view-students-details',
  templateUrl: './view-students-details.component.html',
  styleUrls: ['./view-students-details.component.css']
})
export class ViewStudentsDetailsComponent implements OnInit {
  student_id:any;

...
import { sponsorMenuItems } from 'src/app/shared/menu-items/sponsor-menu';

@Component({
  selector: 'app-sponsors-layout',
  templateUrl: './sponsors-layout.component.html',
  styleUrls: ['./sponsors-layout.component.css'],
  animations: [
...
export class SponsorsLayoutComponent implements OnInit {
  ...
  constructor(public menuItems: sponsorMenuItems,private ds:DataserviceService,private toastr:ToastrService,
